...
public class DuelHistoryMapper {
    ...
    public DuelHistoryEntity toEntity(DuelState state, String winnerId) {
        ...
        return DuelHistoryEntity.builder()
                ...
                .playerADeckId(state.getPlayerADeckId())
                .playerBDeckId(state.getPlayerBDeckId())
                .duelType(state.getDuelType() != null ? state.getDuelType() : "CASUAL")
                .winnerId(winnerId)
                .loserId(loserId)
                ...
                .victoryType(state.getVictoryType() != null
                        ? state.getVictoryType()
                        : (winnerId != null ? "NORMAL" : "DRAW"))
    ...
    public DuelHistoryResponse toResponse(DuelHistoryEntity entity) {
        return DuelHistoryResponse.builder()
                ...
                .playerADeckId(entity.getPlayerADeckId())
                .playerBDeckId(entity.getPlayerBDeckId())
                ...
                .victoryType(entity.getVictoryType())
